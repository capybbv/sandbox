 ...
 */
public interface DocumentTypeSearchRepository extends ElasticsearchRepository<DocumentType, Long>, DepartmentSearchRepositoryInternal {}

interface DocumentTypeSearchRepositoryInternal {
    //    Page<DocumentType> search(String query);
...
class DocumentTypeSearchRepositoryInternalImpl implements DocumentTypeSearchRepositoryInternal {
    ...
    public void index(DocumentType entity) {
        repository.findById(entity.getDocumentTypeId()).ifPresent(elasticsearchTemplate::save);
    }
