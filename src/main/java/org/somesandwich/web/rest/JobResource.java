...
import org.somesandwich.service.JobService;
...
/**
 * REST controller for managing {@link org.somesandwich.domain.Job}.
 */
@RestController
...
public class JobResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/{jobId}", consumes = { "application/json", "application/merge-patch+json" })
