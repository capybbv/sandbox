...
import org.somesandwich.service.LocationService;
...
/**
 * REST controller for managing {@link org.somesandwich.domain.Location}.
 */
@RestController
...
public class LocationResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/{locationId}", consumes = { "application/json", "application/merge-patch+json" })
