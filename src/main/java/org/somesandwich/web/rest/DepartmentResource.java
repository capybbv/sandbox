...
import org.somesandwich.service.DepartmentService;
...
/**
 * REST controller for managing {@link org.somesandwich.domain.Department}.
 */
@RestController
...
public class DepartmentResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/{departmentId}", consumes = { "application/json", "application/merge-patch+json" })
