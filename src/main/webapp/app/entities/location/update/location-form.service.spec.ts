...
describe('Location Form Service', () => {
  ...
  describe('Service methods', () => {
    ...
    describe('resetForm', () => {
      it('passing ILocation should not enable locationId FormControl', () => {
        const formGroup = service.createLocationFormGroup();
        expect(formGroup.controls.locationId.disabled).toBe(true);
      ...
      it('passing NewLocation should disable locationId FormControl', () => {
        const formGroup = service.createLocationFormGroup(sampleWithRequiredData);
        expect(formGroup.controls.locationId.disabled).toBe(true);

        service.resetForm(formGroup, { locationId: null });
