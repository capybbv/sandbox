...
describe('Location Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Country query and add missing value', () => {
      const location: ILocation = { locationId: 456 };
      const country: ICountry = { countryId: '396268a7-9a92-475b-837e-2caa310e33a4' };
      location.country = country;

      const countryCollection: ICountry[] = [{ countryId: '91c18ae1-6313-4ea6-b2f2-a8a6488369f2' }];
    ...
    it('Should update editForm', () => {
      const location: ILocation = { locationId: 456 };
      const country: ICountry = { countryId: 'f6344637-cd80-4d17-b0fb-4a29728fbdb7' };
      location.country = country;
  ...
  describe('save', () => {
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<ILocation>>();
      const location = { locationId: 123 };
      jest.spyOn(locationFormService, 'getLocation').mockReturnValue({ locationId: null });
