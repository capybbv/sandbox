...
describe('Location routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ILocation returned by find', () => {
      // GIVEN
      service.find = jest.fn(locationId => of(new HttpResponse({ body: { locationId } })));
      mockActivatedRouteSnapshot.params = { locationId: 123 };
      ...
      expect(resultLocation).toEqual({ locationId: 123 });
    });
