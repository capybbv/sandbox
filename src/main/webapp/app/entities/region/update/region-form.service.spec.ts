...
describe('Region Form Service', () => {
  ...
  describe('Service methods', () => {
    ...
    describe('resetForm', () => {
      it('passing IRegion should not enable regionId FormControl', () => {
        const formGroup = service.createRegionFormGroup();
        expect(formGroup.controls.regionId.disabled).toBe(true);
      ...
      it('passing NewRegion should disable regionId FormControl', () => {
        const formGroup = service.createRegionFormGroup(sampleWithRequiredData);
        expect(formGroup.controls.regionId.disabled).toBe(true);

        service.resetForm(formGroup, { regionId: null });
