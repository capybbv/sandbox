...
export type PartialUpdateRegion = Partial<IRegion> & Pick<IRegion, 'regionId'>;
...
export class RegionService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/regions/_search');
  ...
  getRegionIdentifier(region: Pick<IRegion, 'regionId'>): number {
    return region.regionId;
  }

  compareRegion(o1: Pick<IRegion, 'regionId'> | null, o2: Pick<IRegion, 'regionId'> | null): boolean {
    return o1 && o2 ? this.getRegionIdentifier(o1) === this.getRegionIdentifier(o2) : o1 === o2;
  }

  addRegionToCollectionIfMissing<Type extends Pick<IRegion, 'regionId'>>(
