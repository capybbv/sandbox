...
export type PartialUpdateDepartment = Partial<IDepartment> & Pick<IDepartment, 'departmentId'>;
...
export class DepartmentService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/departments/_search');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<IDepartment[]>()], asapScheduler)));
  }

  getDepartmentIdentifier(department: Pick<IDepartment, 'departmentId'>): number {
    return department.departmentId;
  }

  compareDepartment(o1: Pick<IDepartment, 'departmentId'> | null, o2: Pick<IDepartment, 'departmentId'> | null): boolean {
    return o1 && o2 ? this.getDepartmentIdentifier(o1) === this.getDepartmentIdentifier(o2) : o1 === o2;
  }

  addDepartmentToCollectionIfMissing<Type extends Pick<IDepartment, 'departmentId'>>(
