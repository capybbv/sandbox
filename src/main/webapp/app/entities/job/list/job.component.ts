...
export class JobComponent implements OnInit {
  private static readonly NOT_SORTABLE_FIELDS_AFTER_SEARCH = ['jobId', 'jobTitle'];
  ...
  trackJobId = (_index: number, item: IJob): string => this.jobService.getJobIdentifier(item);
