...
export type PartialUpdateJob = Partial<IJob> & Pick<IJob, 'jobId'>;
...
export class JobService {
  ...
  getJobIdentifier(job: Pick<IJob, 'jobId'>): string {
    return job.jobId;
  }

  compareJob(o1: Pick<IJob, 'jobId'> | null, o2: Pick<IJob, 'jobId'> | null): boolean {
    return o1 && o2 ? this.getJobIdentifier(o1) === this.getJobIdentifier(o2) : o1 === o2;
  }

  addJobToCollectionIfMissing<Type extends Pick<IJob, 'jobId'>>(
    jobCollection: Type[],
