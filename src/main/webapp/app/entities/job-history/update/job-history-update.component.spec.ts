...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Job query and add missing value', () => {
      ...
      const job: IJob = { jobId: 'a3f78340-a27f-41d2-abc3-b761e9b6e9a8' };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ jobId: 'ce881dd0-5c7b-4840-9426-42e07ff25e8d' }];
    ...
    it('Should call Department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { departmentId: 24164 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ departmentId: 18812 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { employeeId: 7399 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ employeeId: 2312 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { jobId: '3369c2df-efcc-4546-a22a-c89be41a205d' };
      jobHistory.job = job;
      const department: IDepartment = { departmentId: 11808 };
      jobHistory.department = department;
      const employee: IEmployee = { employeeId: 15016 };
      jobHistory.employee = employee;
