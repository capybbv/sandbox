...
describe('Employee Form Service', () => {
  ...
  describe('Service methods', () => {
    ...
    describe('resetForm', () => {
      it('passing IEmployee should not enable employeeId FormControl', () => {
        const formGroup = service.createEmployeeFormGroup();
        expect(formGroup.controls.employeeId.disabled).toBe(true);
      ...
      it('passing NewEmployee should disable employeeId FormControl', () => {
        const formGroup = service.createEmployeeFormGroup(sampleWithRequiredData);
        expect(formGroup.controls.employeeId.disabled).toBe(true);

        service.resetForm(formGroup, { employeeId: null });
