...
describe('Employee routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEmployee returned by find', () => {
      // GIVEN
      service.find = jest.fn(employeeId => of(new HttpResponse({ body: { employeeId } })));
      mockActivatedRouteSnapshot.params = { employeeId: 123 };
      ...
      expect(resultEmployee).toEqual({ employeeId: 123 });
    });
