...
export type PartialUpdateEmployee = Partial<IEmployee> & Pick<IEmployee, 'employeeId'>;
...
export class EmployeeService {
  ...
  getEmployeeIdentifier(employee: Pick<IEmployee, 'employeeId'>): number {
    return employee.employeeId;
  }

  compareEmployee(o1: Pick<IEmployee, 'employeeId'> | null, o2: Pick<IEmployee, 'employeeId'> | null): boolean {
    return o1 && o2 ? this.getEmployeeIdentifier(o1) === this.getEmployeeIdentifier(o2) : o1 === o2;
  }

  addEmployeeToCollectionIfMissing<Type extends Pick<IEmployee, 'employeeId'>>(
