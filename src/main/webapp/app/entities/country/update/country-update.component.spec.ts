...
describe('Country Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Region query and add missing value', () => {
      ...
      const region: IRegion = { regionId: 27306 };
      country.region = region;

      const regionCollection: IRegion[] = [{ regionId: 28910 }];
    ...
    it('Should update editForm', () => {
      const country: ICountry = { countryId: 'CBA' };
      const region: IRegion = { regionId: 2251 };
      country.region = region;
  ...
  describe('save', () => {
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<ICountry>>();
      const country = { countryId: 'ABC' };
      jest.spyOn(countryFormService, 'getCountry').mockReturnValue({ countryId: null });
