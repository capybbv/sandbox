...
export class CountryComponent implements OnInit {
  private static readonly NOT_SORTABLE_FIELDS_AFTER_SEARCH = ['countryId', 'countryName'];
  ...
  trackCountryId = (_index: number, item: ICountry): string => this.countryService.getCountryIdentifier(item);
