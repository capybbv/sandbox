...
class CountryResourceIT {
    ...
    void createCountryWithExistingId() throws Exception {
        ...
        country.setCountryId("existing_id");
    ...
    void getAllCountries() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.[*].countryId").value(hasItem(country.getCountryId())))
    ...
    void getCountry() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.countryId").value(country.getCountryId()))
    ...
    void putExistingCountry() throws Exception {
        ...
        // Update the country
        Country updatedCountry = countryRepository.findById(country.getCountryId()).orElseThrow();
    ...
    void searchCountry() throws Exception {
        ...
        // Search the country
        restCountryMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + country.getCountryId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].countryId").value(hasItem(country.getCountryId())))
            .andExpect(jsonPath("$.[*].countryName").value(hasItem(DEFAULT_COUNTRY_NAME)));
