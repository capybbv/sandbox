...
import org.somesandwich.IntegrationTest;
...
class DepartmentResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{departmentId}";
    ...
    void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc
            .perform(get(ENTITY_API_URL + "?sort=departmentId,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].departmentId").value(hasItem(department.getDepartmentId().intValue())))
    ...
    void getDepartment() throws Exception {
        ...
        // Get the department
        restDepartmentMockMvc
            .perform(get(ENTITY_API_URL_ID, department.getDepartmentId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.departmentId").value(department.getDepartmentId().intValue()))
    ...
    void putExistingDepartment() throws Exception {
        ...
        Department updatedDepartment = departmentRepository.findById(department.getDepartmentId()).orElseThrow();
        ...
        restDepartmentMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedDepartment.getDepartmentId())
    ...
    void putNonExistingDepartment() throws Exception {
        int databaseSizeBeforeUpdate = departmentRepository.findAll().size();
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(departmentSearchRepository.findAll());
        department.setDepartmentId(longCount.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restDepartmentMockMvc
            .perform(
                put(ENTITY_API_URL_ID, department.getDepartmentId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.setDepartmentId(department.getDepartmentId());

        restDepartmentMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedDepartment.getDepartmentId())
    ...
    void patchNonExistingDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, department.getDepartmentId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(department))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            .perform(delete(ENTITY_API_URL_ID, department.getDepartmentId()).accept(MediaType.APPLICATION_JSON))
    ...
    void searchDepartment() throws Exception {
        ...
        restDepartmentMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + department.getDepartmentId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].departmentId").value(hasItem(department.getDepartmentId().intValue())))
            .andExpect(jsonPath("$.[*].departmentName").value(hasItem(DEFAULT_DEPARTMENT_NAME)));
