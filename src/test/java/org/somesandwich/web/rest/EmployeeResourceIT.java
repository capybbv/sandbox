...
class EmployeeResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{employeeId}";
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            .perform(get(ENTITY_API_URL + "?sort=employeeId,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].employeeId").value(hasItem(employee.getEmployeeId().intValue())))
    ...
    void getEmployee() throws Exception {
        ...
        // Get the employee
        restEmployeeMockMvc
            .perform(get(ENTITY_API_URL_ID, employee.getEmployeeId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.employeeId").value(employee.getEmployeeId().intValue()))
    ...
    void putExistingEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedEmployee.getEmployeeId())
    ...
    void putNonExistingEmployee() throws Exception {
        int databaseSizeBeforeUpdate = employeeRepository.findAll().size();
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(employeeSearchRepository.findAll());
        employee.setEmployeeId(longCount.incrementAndGet());

        // If the entity doesn't have an ID, it will throw BadRequestAlertException
        restEmployeeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, employee.getEmployeeId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.setEmployeeId(employee.getEmployeeId());
        ...
        restEmployeeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedEmployee.getEmployeeId())
    ...
    void patchNonExistingEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, employee.getEmployeeId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(employee))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteEmployee() throws Exception {
        ...
        // Delete the employee
        restEmployeeMockMvc
            .perform(delete(ENTITY_API_URL_ID, employee.getEmployeeId()).accept(MediaType.APPLICATION_JSON))
    ...
    void searchEmployee() throws Exception {
        ...
        // Search the employee
        restEmployeeMockMvc
            .perform(get(ENTITY_SEARCH_API_URL + "?query=id:" + employee.getEmployeeId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].employeeId").value(hasItem(employee.getEmployeeId().intValue())))
            .andExpect(jsonPath("$.[*].firstName").value(hasItem(DEFAULT_FIRST_NAME)))
