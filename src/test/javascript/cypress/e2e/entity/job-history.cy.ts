...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="employeeId"]`).type('27139');
      cy.get(`[data-cy="employeeId"]`).should('have.value', '27139');

      cy.get(`[data-cy="startDate"]`).type('2023-12-25T17:59');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2023-12-25T17:59');

      cy.get(`[data-cy="endDate"]`).type('2023-12-25T21:30');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2023-12-25T21:30');

      cy.get(`[data-cy="salary"]`).type('18072');
      cy.get(`[data-cy="salary"]`).should('have.value', '18072');
