...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobId"]`).type('e0042c3c-ea08-4a5e-9e6c-659600d155b7');
      cy.get(`[data-cy="jobId"]`).should('have.value', 'e0042c3c-ea08-4a5e-9e6c-659600d155b7');

      cy.get(`[data-cy="jobTitle"]`).type('Dynamic Mobility Developer');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Dynamic Mobility Developer');

      cy.get(`[data-cy="minSalary"]`).type('7525');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '7525');

      cy.get(`[data-cy="maxSalary"]`).type('27134');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '27134');
