...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Magali');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Magali');

      cy.get(`[data-cy="lastName"]`).type('Barton');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Barton');

      cy.get(`[data-cy="email"]`).type('Marjorie_Ankunding@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Marjorie_Ankunding@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('whereas unnaturally');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'whereas unnaturally');

      cy.get(`[data-cy="hireDate"]`).type('2023-12-26T02:52');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2023-12-26T02:52');

      cy.get(`[data-cy="salary"]`).type('12706');
      cy.get(`[data-cy="salary"]`).should('have.value', '12706');

      cy.get(`[data-cy="commissionPct"]`).type('17055');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '17055');
