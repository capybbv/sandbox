...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('redo');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'redo');

      cy.get(`[data-cy="postalCode"]`).type('failing');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'failing');

      cy.get(`[data-cy="city"]`).type('Lake Tyresemouth');
      cy.get(`[data-cy="city"]`).should('have.value', 'Lake Tyresemouth');

      cy.get(`[data-cy="stateProvince"]`).type('wreck accompany with');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'wreck accompany with');
